...
void MPU6050_WriteReg(uint8_t RegAddress, uint8_t Data)
{
	...
	MPU6050_WaitEVent(I2C2, I2C_EVENT_MASTER_MODE_SELECT);//等待世家ev_5
	//硬件发送从机地址
...
void MPU6050_Init(void)
{
	...
	I2C_InitStruct.I2C_ClockSpeed = 50000;//时钟速度50khz
	I2C_InitStruct.I2C_DutyCycle = I2C_DutyCycle_2;//时钟占空比，低：高 = 2
	I2C_InitStruct.I2C_OwnAddress1 = 0x00;//自身地址从机模式下有效
